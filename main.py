...
def gemini_image(prompt: str, output: Path):
    ...
    payload = {"model": "gemini-3.1-flash-image", "input": prompt, "response_format": {"type": "image", "aspect_ratio": "9:16", "image_size": "1K"}}
...
def main():
    ...
    prompt = f"Create a premium devotional palm-art illustration for a vertical 9:16 social media short about {topic}. Show {deity} as the central devotional subject emerging from a realistic human palm/hand drawing, intricate black ink pen artwork on warm off-white paper, elegant Indian spiritual motifs, subtle golden devotional atmosphere, cinematic soft lighting, highly detailed hand-drawn linework, clean composition, no watermark, no modern objects, no text. Mobile-first 9:16 composition."
